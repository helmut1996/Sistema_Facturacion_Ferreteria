...
public class ProductosAdd {
    ...
    public ProductosAdd(String id_producto, String nombreproduc, int cantidad, double precios, String imagenProducto, int idcliente, int idvendedor, String tipoprecio, float porcentaje) {
